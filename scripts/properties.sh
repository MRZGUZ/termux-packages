...
TERMUX_APP_PACKAGE="com.webs.app"
...
# Path to CGCT tools
CGCT_DEFAULT_PREFIX="/data/data/com.webs/files/usr/glibc"
export CGCT_DIR="/data/data/com.webs.app/cgct"
...
TERMUX_REPO_PACKAGE="com.webs.app"
